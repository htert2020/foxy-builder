...
class Settings
{
    ...
    public function admin_menu()
    {
        ...
        $page_label = __('Settings', 'foxy-builder');
        $this->menu_short_name = 'foxybuilder';
    ...
    public function action_in_admin_header()
    {
        if ($this->page_loading)
        {
            ...
            \FoxyBuilder\Admin\Includes\Header::instance()->set_title(__('Foxy Builder', 'foxy-builder'));
    ...
    {
        require FOXYBUILDER_PLUGIN_PATH . '/admin/menu/pages/settings.php';
    }
}
